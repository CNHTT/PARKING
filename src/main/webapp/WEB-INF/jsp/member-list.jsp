...
<nav class="breadcrumb">
    ...
    Member List <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace('/member_list');" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
