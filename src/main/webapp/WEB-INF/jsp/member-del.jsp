...
<div class="page-container">
    <div class="text-c">
        <form action="member_del_LPM" class="form form-horizontal" method="post">
    ...
    <table class="table table-border table-bordered table-bg">
        ...
        <c:choose>
            ...
            <c:otherwise>
                <tr>
                    <td  scope="col" colspan="10"> No Find Del Member!!!  Please Check  MemberList</td>
                </tr>
            </c:otherwise>
        </c:choose>
        </tbody>
...
<script type="text/javascript">
    ...
    function member_huanyuan(obj,id){
        layer.confirm('Are you sure you want to restore?',
            {btn:['Ok','Cancel']},function(index){
                $.ajax({
                    type: 'POST',
                    url: '',
